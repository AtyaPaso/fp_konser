...
namespace FP_Konser.Model
{
    class ModelTemplateQuery
    {
        ...
        public static SqlConnection GetConnection()
        {
            ...
            conn.ConnectionString = "Data Source = DESKTOP-8QQVB9N;" +
                                    "Initial Catalog = konser;" +
        ...
        public DataSet CustomSelect(string select, string tabel, string kondisi = "") //function select data (read)
        {
            GetConnection();
            ...
            if (kondisi == "")
            {
                command.CommandText = "SELECT " + select + " FROM " + tabel;
            }
            else
            {
                command.CommandText = "SELECT " + select + " FROM " + tabel + " " + kondisi;
            }
